        ...
        <div class="edu_content">
          <div class="edu_data" >
            <div className="edu_detailLeft">
              <h3 class="edu_title">BE Mechatronics</h3>
              <span class="edu_subtitle">Thiagarajar College of Engineering, Madurai</span>
          ...
          <div class="edu_data">
            ...
            <div className="edu_detailRight">
              <h3 class="edu_title">HSC</h3>
              <span class="edu_subtitle">NSMVPS Higher Secondary School, Devakottai</span>
              <div class="edu_calendar">
